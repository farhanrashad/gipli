...
class SalaryAdjustmentAllowance(models.Model):
    ...
    calc_company_id=fields.Many2one('res.company', string='Calculated', compute='_compute_company')
    ...
    is_post = fields.Boolean(string='Validated') 
        ...
        for line in self:
            if line.employee_id:
                line.update({
                    ...
                    'calc_company_id': line.employee_id.company_id.id,  
                })
            else:
                line.update({
                    'company_id': self.env.company,
                    'calc_company_id':  self.env.company,
                })
