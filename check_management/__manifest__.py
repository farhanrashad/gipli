# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'account', 'account_accountant','add_real_estate'],#' 'account_accountant', 'sale'
    ...
    'data': [
        ...
        'views/paymet_print.xml',
        'views/payment_all.xml',
        'views/customer_type.xml',
        'views/account.xml',
        'views/petty_cash_reconcile.xml',
        'data/sms_temp.xml',
